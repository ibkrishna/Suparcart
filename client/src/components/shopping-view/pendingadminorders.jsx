...
function AdminPendingOrders() {
  ...
  // Filter orders that are pending (not delivered)
  ...
  return (
    <div className="p-4">
      <h2 className="font-medium text-xl" style={{ fontFamily: 'Inter' }}>Pending Orders</h2>
        ...
        <table className="min-w-full border-collapse">
          ...
          <tbody>
            {currentOrders.length > 0 ? currentOrders.map((orderItem) => {
              ...
              <tr>
                <td colSpan="5" className="text-center px-4 py-2">No pending orders found</td>
              </tr>
            )}
          </tbody>
        </table>
      ...
      <div className="md:hidden mt-4">
        {currentOrders.length > 0 ? currentOrders.map((orderItem) => {
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <div className="flex items-center">
                      <div className="w-20 text-white text-center bg-black">
                        {orderItem.orderStatus}
                      </div>
                    </div>
                  </div>
          ...
          <div className="text-center">No pending orders found</div>
        )}
      </div>

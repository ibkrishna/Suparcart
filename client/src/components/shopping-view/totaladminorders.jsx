...
function AdminTotalOrders() {
  ...
  return (
    <div className="p-4">
      <h2 className="font-medium text-xl" style={{ fontFamily: 'Inter' }}>All Orders</h2>
          ...
          <tbody>
            {currentOrders.length > 0 ? currentOrders.map((orderItem) => (
              <tr key={orderItem._id}>
                ...
                <td className="border-b px-4 py-2">
                  <Badge className={`py-1 px-3 bg-slate-700`}>
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <div className="flex items-center">
                    <div className="w-20 text-white text-center bg-yellow-500">
                      {orderItem.orderStatus}
                    </div>
                  </div>
                </div>

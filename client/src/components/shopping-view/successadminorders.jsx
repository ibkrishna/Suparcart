...
function AdminSuccessfulOrders() {
  ...
  // Filter orders with trackingStatus "delivered"
  const filteredOrderList = orderList?.filter(order => order.trackingStatus === "delivered");

  const sortedOrderList = filteredOrderList?.slice().sort((a, b) => {
  ...
  return (
    <div className="p-4">
      <h2 className="font-medium text-xl" style={{ fontFamily: 'Inter' }}>Successful Orders</h2>
            ...
            {currentOrders.length > 0 ? currentOrders.map((orderItem) => {
              ...
              return (
                <tr key={orderItem._id}>
                  ...
                  <td className="border-b px-4 py-2">
                    <Badge className={`py-1 px-3 bg-green-700`}>
                      {orderItem.trackingStatus} {/* Use trackingStatus */}
                    </Badge>
                  </td>
              ...
              <tr>
                <td colSpan="5" className="text-center px-4 py-2">No successful orders found</td>
              </tr>
            )}
          </tbody>
        </table>
      ...
      <div className="md:hidden mt-4">
        {currentOrders.length > 0 ? currentOrders.map((orderItem) => {
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <div className="flex items-center">
                      <div className="w-20 text-white text-center bg-green-500">
          ...
          <div className="text-center">No successful orders found</div>
        )}
      </div>
...
export default AdminSuccessfulOrders;
